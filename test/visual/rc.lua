-- jev-lsp, set up and nothing else: no fixture, no autocommands, no options touched.
--
...
--   JEV_REVIEW_MODEL  defaults to JEV_MODEL
...
local REVIEW = os.getenv('JEV_REVIEW_MODEL') or MODEL
