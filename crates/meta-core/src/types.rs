...
pub const ARTIFACT_SCHEMA: &str = "meta.artifact/1";
/// Schema version stamped on every command result (PROTOCOL.md §7).
pub const RESULT_SCHEMA: &str = "meta.result/1";
...
impl Verb {
    ...
    pub fn kind(self) -> &'static str {
        match self {
            Verb::Fix => "quickfix.meta",
            Verb::FixAll => "source.fixAll",
            Verb::Explain | Verb::Review => "source.meta",
            _ => "refactor.rewrite.meta",
        }
    }
